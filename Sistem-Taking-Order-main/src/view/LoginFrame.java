...
public class LoginFrame extends JFrame {
    ...
    // Enhanced authentication method with predefined users
    private boolean authenticateUser(String username, String password) {
        ...
        switch (username.toLowerCase()) {
            ...
            case "kasir":
                return password.equals("kasir123");
            case "manager":
                return password.equals("manager123");
            default:
                return false;
        }
    }
    
    // Enhanced method to get user role
    ...
    // Updated openDashboard method with KasirApp integration
    private void openDashboard(String role) {
        SwingUtilities.invokeLater(() -> {
            try {
                switch (role) {
                    case "ADMIN":
                        // Uncomment when AdminFrame is ready
                        // new AdminFrame().setVisible(true);
                        new AdminFrame().setVisible(true);
                        break;
                    case "KASIR":
                        // Open KasirApp instead of showing message
